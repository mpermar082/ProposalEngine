// src/lib.rs
/*
 * Core library for ProposalEngine
 */
...
#[derive(Debug)]
pub struct ProposalEngineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ProposalEngineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ProposalEngine processing");
    
    let mut processor = ProposalEngineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ProposalEngineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ProposalEngineProcessor::new(false);
